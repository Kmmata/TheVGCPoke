...
const RegulationMB = (() => {
  ...
  const LEGAL_POKEMON = [
    ...
    { name: 'Aegislash', types: ['Steel','Ghost'], baseStats: {hp:60,atk:50,atk:140,def:140,spa:50,spa:140,spd:50,spd:140,spe:60,spe:60}, abilities: ['Stance Change'] },
    ...
    { name: 'Froslass', types: ['Ice','Ghost'], baseStats: {hp:70,atk:80,def:70,spa:80,spd:70,spa:80,spd:70,spe:110}, abilities: ['Snow Cloak','Cursed Body'] },
